 ...
 *
 * MapperScan은 com.mediac.app 패키지 이하에서 {@link spring.core.mybatis.Mapper}
...
@MapperScan(basePackages = "com.mediac.app", annotationClass = Mapper.class)
public class DatabaseConfig implements InitializingBean {
     ...
     * {@link spring.EnvironmentInitializer}에 의해 등록된 JDBC 설정정보를 사용한다.
     *
    ...
    public DataSource dataSource() {
        ...
        dataSource.setDriverClass(environment.getRequiredProperty("jdbc.driverClass")); // 이부분 고쳐야함.,
